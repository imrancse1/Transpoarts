...
class CreateLessPurchasesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('less_purchases', function (Blueprint $table) {
            $table->increments('less_purchase_id');
    ...
    {
        Schema::dropIfExists('less_purchases');
    }
}
