     ...
     <div class="row ">
       ...
       <div class="col-xs-8 col-sm-8 col-md-8">
        ...
        <div class="col-xs-8 col-sm-8 col-md-8">
         <br><label for="product_id" class="col-form-label col-sm-3 text-right">Product Name:</label>
          ...
          <div class="col-xs-8 col-sm-8 col-md-8">
            ...
            <div class="col-sm-7">
            <input type="text" class="form-control" name="order_quantity"  id="order_quantity" placeholder="Write order quantity here"  required>          
             </div>
             <div class="col-sm-2">
         ...
         <div class="col-xs-8 col-sm-8 col-md-8">
            ...
            <div class="col-sm-7">
            <input type="text" class="form-control" name="supplier_chalan_qty"  id="supplier_chalan_qty" placeholder="Write supplier chalan quantity here"  required>          
             </div>
             <div class="col-sm-2">
          ...
          <div class="col-xs-8 col-sm-8 col-md-8">
            ...
            <div class="col-sm-9">
            <input type="text" class="form-control" name="receive_quantity"  id="receive_quantity" placeholder="Write receive quantity here" required>
         ...
         <div class="col-xs-8 col-sm-8 col-md-8">
            ...
            <div class="col-sm-9">
            <input type="text" class="form-control" name="weight_quantity"  id="weight_quantity" placeholder="Write weight quantity here" required>
        ...
        <div class="col-xs-8 col-sm-8 col-md-8">
            ...
            <div class="col-sm-9">
            <input type="text" class="form-control" name="remain_quantity"  id="remain_quantity" placeholder="Write remain quantity here" required>
        ...
        <div class="col-xs-8 col-sm-8 col-md-8">
            ...
            <div class="col-sm-9">
            <input type="text" class="form-control" name="sack_purchase"  id="sack_purchase"  required>
          ...
          <div class="col-xs-8 col-sm-8 col-md-8">
            ...
            <div class="col-sm-9">
            <input type="text" class="form-control" name="moisture"  id="moisture"  required>
        ...
        <div class="col-xs-8 col-sm-8 col-md-8">
            ...
            <div class="col-sm-7">
            <input type="text" class="form-control" name="deduction_quantity"  id="deduction_quantity" placeholder="Write deduction quantity here" required>
         ...
         <div class="col-xs-8 col-sm-8 col-md-8">
            ...
            <div class="col-sm-9">
            <input type="text" class="form-control" name="bill_quantity"  id="bill_quantity" placeholder="Write bill quantity" required>
         ...
         <div class="col-xs-8 col-sm-8 col-md-8">
            ...
            <div class="col-sm-9">
            <input type="text" class="form-control" name="purchase_rate"  id="purchase_rate" placeholder="Write purchase rate" required>
         ...
         <br><label for="transport_vehicle" class="col-form-label col-sm-3 text-right">Transport Vehicle:</label>
             <div class="col-sm-9">
            <input type="text" class="form-control" name="transport_vehicle"  id="transport_vehicle" placeholder="Write transport Vehicle" required>
         ...
         <div class="col-xs-8 col-sm-8 col-md-8">
            ...
            <div class="col-sm-9">
            <input type="number" class="form-control" name="transport_fare"  id="transport_fare" placeholder="Write transport fare here" required>
         ...
         <div class="col-xs-8 col-sm-8 col-md-8">
            ...
            <div class="col-sm-9">
            <input type="text" class="form-control" name="total_payable_amount"  id="total_payable_amount" placeholder="Write total payable amount" required>
