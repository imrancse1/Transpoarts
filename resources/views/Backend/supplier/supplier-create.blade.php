    ...
    @csrf
     <div class="row">
        ...
        <div class="col-xs-8 col-sm-8 col-md-8">
             ...
             <div class="col-sm-9">
                <input type="text" class="form-control" name="supplier_name" value="" id="supplier_name" placeholder="Write supplier name here" required>
         ...
         <div class="col-xs-8 col-sm-8 col-md-8">
             ...
             <div class="col-sm-9">
                <input type="text" class="form-control" name="supplier_phone" value="" id="supplier_phone" placeholder="Write Supplier Phone Number" required>
         ...
         <div class="col-xs-8 col-sm-8 col-md-8">
             ...
             <div class="col-sm-9">
                <input type="text" class="form-control" name="supplier_address" value="" id="supplier_address" placeholder="Write supplier address here" >
         ...
         <div class="col-xs-8 col-sm-8 col-md-8">
             ...
             <div class="col-sm-9">
                <input type="text" class="form-control" name="supplier_company" value="" id="supplier_company" placeholder="Write supplier company here" >
