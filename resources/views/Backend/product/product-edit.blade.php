     ...
     <div class="row">
      ...
      <div class="col-xs-8 col-sm-8 col-md-8">
          <br>    <label for="batchName" class="col-form-label col-sm-3 text-right">Product Name:</label>
               <div class="col-sm-9">
                   <input type="text" class="form-control" name="product_name" id="productName" value="{{$product->product_name}}" placeholder="Write Product Name" required>
       ...
       <div class="col-xs-8 col-sm-8 col-md-8">
            <br>  <label for="batchName" class="col-form-label col-sm-3 text-right">Weight Unit Tons:</label>
               <div class="col-sm-9">
                   <input type="text" class="form-control" name="weight_unit_tons" id="weight_unit_tons" value="{{$product->weight_unit_tons}}" placeholder="Write weight unit tons" required>
