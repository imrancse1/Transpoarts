...
<form action="{{ route('priceTrip.store') }}" method="POST">
    @csrf
     <div class="row">
        <div class="col-xs-8 col-sm-8 col-md-8">
           <br>     <label for="input_vehicle_id" class="col-form-label col-sm-3 text-right">Number of Trip </label>
                   <div class="col-sm-9">
                     <select name="trip_info_id" class="form-control" id="input_vehicle_id" required="">
